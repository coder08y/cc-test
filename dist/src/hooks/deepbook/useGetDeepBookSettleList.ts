...
export default function useGetDeepBookSettleList() {
  ...
  const getSettleList = async () => {
    ...
    try {
      ...
      console.log('🚀🚀🚀 ~ useGetDeepBookSettleList.ts:18 ~ getSettleList ~ deepBookAccount:', deepBookAccount)
      ...
      console.log('🚀🚀🚀 ~ useGetDeepBookSettleList.ts:29 ~ getSettleList ~ res:', res)
      if (!res) {
