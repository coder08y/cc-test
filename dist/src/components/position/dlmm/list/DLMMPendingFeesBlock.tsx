...
const DLMMPendingFeesBlock = ({ positionInfo, onFeesChange }: { positionInfo: DlmmPosBaseInfo; onFeesChange: (value: any) => void }) => {
  const [isShowInfo, setIsShowInfo] = useState(false)

  const { getTokenAmountValue } = useTokenPrice()
  const { dlmmPosFeeData } = useDlmmPositionStore()
...
export default DLMMPendingFeesBlock
