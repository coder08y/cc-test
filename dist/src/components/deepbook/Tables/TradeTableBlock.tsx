...
function TradeTableBlock() {
  ...
  useDeepCompareEffect(() => {
    console.log('🚀🚀🚀 ~ TradeTableBlock.tsx:539 ~ TradeTableBlock ~ marginManagerByAccount:', marginManagerByAccount)

    if (!currentAccount?.address || !currentSelectedManagerInfo) {
    ...
    if (isInitialRender || tabChanged || orderTypeChanged || poolChanged || allMarketsChanged || accountChanged) {
      ...
      console.log('🚀🚀🚀 ~ TradeTableBlock.tsx:466 ~ TradeTableBlock ~ accountChanged:', accountChanged)
