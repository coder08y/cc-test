...
// ../../node_modules/.pnpm/ws@7.5.10_bufferutil@4.1.0_utf-8-validate@5.0.10/node_modules/ws/browser.js
var require_browser = __commonJS({
  "../../node_modules/.pnpm/ws@7.5.10_bufferutil@4.1.0_utf-8-validate@5.0.10/node_modules/ws/browser.js"(exports, module) {
    "use strict";
    var import_dist145 = __toESM(require_dist());
    var import_dist146 = __toESM(require_dist2());
    var import_dist147 = __toESM(require_dist3());
...
var __spreadArray = function(to2, from3, pack) {
  if (pack || arguments.length === 2) for (var i2 = 0, l5 = from3.length, ar2; i2 < l5; i2++) {
    if (ar2 || !(i2 in from3)) {
...
function Cn(t, e2, n3, r3) {
  ...
  const o5 = BigInt(32), s2 = BigInt(4294967295), a2 = Number(n3 >> o5 & s2), u = Number(n3 & s2), i2 = r3 ? 4 : 0, D2 = r3 ? 0 : 4;
...
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l5 = a2; l5 < o5; l5++) n3[l5] = 0;
    ...
    const D2 = i2 / 4, c4 = this.get();
    if (D2 > c4.length) throw new Error("_sha2: outputLen bigger than state");
    for (let l5 = 0; l5 < D2; l5++) u.setUint32(4 * l5, c4[l5], s2);
  }
  digest() {
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n3, Bh: r3, Bl: o5, Ch: s2, Cl: a2, Dh: u, Dl: i2, Eh: D2, El: c4, Fh: l5, Fl: p2, Gh: w3, Gl: h3, Hh: g3, Hl: S } = this;
    return [e2, n3, r3, o5, s2, a2, u, i2, D2, c4, l5, p2, w3, h3, g3, S];
  }
  set(e2, n3, r3, o5, s2, a2, u, i2, D2, c4, l5, p2, w3, h3, g3, S) {
    this.Ah = e2 | 0, this.Al = n3 | 0, this.Bh = r3 | 0, this.Bl = o5 | 0, this.Ch = s2 | 0, this.Cl = a2 | 0, this.Dh = u | 0, this.Dl = i2 | 0, this.Eh = D2 | 0, this.El = c4 | 0, this.Fh = l5 | 0, this.Fl = p2 | 0, this.Gh = w3 | 0, this.Gl = h3 | 0, this.Hh = g3 | 0, this.Hl = S | 0;
  }
  process(e2, n3) {
    for (let d3 = 0; d3 < 16; d3++, n3 += 4) P[d3] = e2.getUint32(n3), Q[d3] = e2.getUint32(n3 += 4);
    for (let d3 = 16; d3 < 80; d3++) {
      const m2 = P[d3 - 15] | 0, F = Q[d3 - 15] | 0, q = x.rotrSH(m2, F, 1) ^ x.rotrSH(m2, F, 8) ^ x.shrSH(m2, F, 7), z2 = x.rotrSL(m2, F, 1) ^ x.rotrSL(m2, F, 8) ^ x.shrSL(m2, F, 7), I = P[d3 - 2] | 0, O3 = Q[d3 - 2] | 0, ot = x.rotrSH(I, O3, 19) ^ x.rotrBH(I, O3, 61) ^ x.shrSH(I, O3, 6), tt = x.rotrSL(I, O3, 19) ^ x.rotrBL(I, O3, 61) ^ x.shrSL(I, O3, 6), st = x.add4L(z2, tt, Q[d3 - 7], Q[d3 - 16]), at = x.add4H(st, q, ot, P[d3 - 7], P[d3 - 16]);
      P[d3] = at | 0, Q[d3] = st | 0;
    }
    let { Ah: r3, Al: o5, Bh: s2, Bl: a2, Ch: u, Cl: i2, Dh: D2, Dl: c4, Eh: l5, El: p2, Fh: w3, Fl: h3, Gh: g3, Gl: S, Hh: v3, Hl: L2 } = this;
    for (let d3 = 0; d3 < 80; d3++) {
      const m2 = x.rotrSH(l5, p2, 14) ^ x.rotrSH(l5, p2, 18) ^ x.rotrBH(l5, p2, 41), F = x.rotrSL(l5, p2, 14) ^ x.rotrSL(l5, p2, 18) ^ x.rotrBL(l5, p2, 41), q = l5 & w3 ^ ~l5 & g3, z2 = p2 & h3 ^ ~p2 & S, I = x.add5L(L2, F, z2, Yn[d3], Q[d3]), O3 = x.add5H(I, v3, m2, q, Vn[d3], P[d3]), ot = I | 0, tt = x.rotrSH(r3, o5, 28) ^ x.rotrBH(r3, o5, 34) ^ x.rotrBH(r3, o5, 39), st = x.rotrSL(r3, o5, 28) ^ x.rotrBL(r3, o5, 34) ^ x.rotrBL(r3, o5, 39), at = r3 & s2 ^ r3 & u ^ s2 & u, Ct = o5 & a2 ^ o5 & i2 ^ a2 & i2;
      v3 = g3 | 0, L2 = S | 0, g3 = w3 | 0, S = h3 | 0, w3 = l5 | 0, h3 = p2 | 0, { h: l5, l: p2 } = x.add(D2 | 0, c4 | 0, O3 | 0, ot | 0), D2 = u | 0, c4 = i2 | 0, u = s2 | 0, i2 = a2 | 0, s2 = r3 | 0, a2 = o5 | 0;
      const At = x.add3L(ot, st, Ct);
      r3 = x.add3H(At, O3, tt, at), o5 = At | 0;
    }
    ({ h: r3, l: o5 } = x.add(this.Ah | 0, this.Al | 0, r3 | 0, o5 | 0)), { h: s2, l: a2 } = x.add(this.Bh | 0, this.Bl | 0, s2 | 0, a2 | 0), { h: u, l: i2 } = x.add(this.Ch | 0, this.Cl | 0, u | 0, i2 | 0), { h: D2, l: c4 } = x.add(this.Dh | 0, this.Dl | 0, D2 | 0, c4 | 0), { h: l5, l: p2 } = x.add(this.Eh | 0, this.El | 0, l5 | 0, p2 | 0), { h: w3, l: h3 } = x.add(this.Fh | 0, this.Fl | 0, w3 | 0, h3 | 0), { h: g3, l: S } = x.add(this.Gh | 0, this.Gl | 0, g3 | 0, S | 0), { h: v3, l: L2 } = x.add(this.Hh | 0, this.Hl | 0, v3 | 0, L2 | 0), this.set(r3, o5, s2, a2, u, i2, D2, c4, l5, p2, w3, h3, g3, S, v3, L2);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function Ae(t, e2) {
  ...
  for (; n3 !== M; ) {
    const u = r3 / n3, i2 = r3 % n3, D2 = o5 - s2 * u;
    r3 = n3, n3 = i2, o5 = s2, s2 = D2;
  }
...
function sr(t) {
  ...
  if (r3 === 1) {
    ...
    return function(i2, D2) {
      const c4 = i2.pow(D2, a2);
      if (!i2.eql(i2.sqr(c4), D2)) throw new Error("Cannot find square root");
      return c4;
    };
  }
  const s2 = (n3 + N) / nt;
  return function(u, i2) {
    ...
    let D2 = r3, c4 = u.pow(u.mul(u.ONE, o5), n3), l5 = u.pow(i2, s2), p2 = u.pow(i2, n3);
    for (; !u.eql(p2, u.ONE); ) {
      if (u.eql(p2, u.ZERO)) return u.ZERO;
      let w3 = 1;
      for (let g3 = u.sqr(p2); w3 < D2 && !u.eql(g3, u.ONE); w3++) g3 = u.sqr(g3);
      const h3 = u.pow(c4, N << BigInt(D2 - w3 - 1));
      c4 = u.sqr(h3), l5 = u.mul(l5, h3), p2 = u.mul(p2, c4), D2 = w3;
    }
    return l5;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r3, o5) {
      const s2 = r3.mul(o5, nt), a2 = r3.pow(s2, e2), u = r3.mul(o5, a2), i2 = r3.mul(r3.mul(u, nt), a2), D2 = r3.mul(u, r3.sub(i2, r3.ONE));
...
function _e(t, e2, n3 = false, r3 = {}) {
  ...
  const u = Object.freeze({ ORDER: t, isLE: n3, BITS: o5, BYTES: s2, MASK: er(o5), ZERO: M, ONE: N, create: (i2) => H(i2, t), isValid: (i2) => {
    ...
    return M <= i2 && i2 < t;
  }, is0: (i2) => i2 === M, isOdd: (i2) => (i2 & N) === N, neg: (i2) => H(-i2, t), eql: (i2, D2) => i2 === D2, sqr: (i2) => H(i2 * i2, t), add: (i2, D2) => H(i2 + D2, t), sub: (i2, D2) => H(i2 - D2, t), mul: (i2, D2) => H(i2 * D2, t), pow: (i2, D2) => fr(u, i2, D2), div: (i2, D2) => H(i2 * Ae(D2, t), t), sqrN: (i2) => i2 * i2, addN: (i2, D2) => i2 + D2, subN: (i2, D2) => i2 - D2, mulN: (i2, D2) => i2 * D2, inv: (i2) => Ae(i2, t), sqrt: r3.sqrt || ((i2) => (a2 || (a2 = ir(t)), a2(u, i2))), invertBatch: (i2) => Dr(u, i2), cmov: (i2, D2, c4) => c4 ? D2 : i2, toBytes: (i2) => n3 ? Nt(i2, s2) : ge(i2, s2), fromBytes: (i2) => {
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n3) {
    ...
    for (let D2 = 0; D2 < o5; D2++) {
      i2 = u, a2.push(i2);
      for (let c4 = 1; c4 < s2; c4++) i2 = i2.add(u), a2.push(i2);
      u = i2.double();
    }
    return a2;
  }, wNAF(n3, r3, o5) {
    ...
    const D2 = BigInt(2 ** n3 - 1), c4 = 2 ** n3, l5 = BigInt(n3);
    for (let p2 = 0; p2 < s2; p2++) {
      const w3 = p2 * a2;
      let h3 = Number(o5 & D2);
      o5 >>= l5, h3 > a2 && (h3 -= c4, o5 += gt);
      const g3 = w3, S = w3 + Math.abs(h3) - 1, v3 = p2 % 2 !== 0, L2 = h3 < 0;
      h3 === 0 ? i2 = i2.add(zt(v3, r3[g3])) : u = u.add(zt(L2, r3[S]));
    }
    return { p: u, f: i2 };
  }, wNAFUnsafe(n3, r3, o5, s2 = t.ZERO) {
    const { windows: a2, windowSize: u } = Mt(n3, e2), i2 = BigInt(2 ** n3 - 1), D2 = 2 ** n3, c4 = BigInt(n3);
    for (let l5 = 0; l5 < a2; l5++) {
      const p2 = l5 * u;
      if (o5 === Se) break;
      let w3 = Number(o5 & i2);
      if (o5 >>= c4, w3 > u && (w3 -= D2, o5 += gt), w3 === 0) continue;
      let h3 = r3[p2 + Math.abs(w3) - 1];
...
function br(t, e2, n3, r3) {
  ...
  const o5 = t.ZERO, s2 = tr(BigInt(n3.length)), a2 = s2 > 12 ? s2 - 3 : s2 > 4 ? s2 - 2 : s2 ? 2 : 1, u = (1 << a2) - 1, i2 = new Array(u + 1).fill(o5), D2 = Math.floor((e2.BITS - 1) / a2) * a2;
  let c4 = o5;
  for (let l5 = D2; l5 >= 0; l5 -= a2) {
    i2.fill(o5);
    for (let w3 = 0; w3 < r3.length; w3++) {
      const h3 = r3[w3], g3 = Number(h3 >> BigInt(l5) & BigInt(u));
      i2[g3] = i2[g3].add(n3[w3]);
    }
    let p2 = o5;
    for (let w3 = i2.length - 1, h3 = o5; w3 > 0; w3--) h3 = h3.add(i2[w3]), p2 = p2.add(h3);
    if (c4 = c4.add(p2), l5 !== 0) for (let w3 = 0; w3 < a2; w3++) c4 = c4.double();
  }
  return c4;
}
function pr(t) {
...
function yr(t) {
  const e2 = gr(t), { Fp: n3, n: r3, prehash: o5, hash: s2, randomBytes: a2, nByteLength: u, h: i2 } = e2, D2 = yt << BigInt(u * 8) - j, c4 = n3.create, l5 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y2, f3) => {
    try {
      return { isValid: true, value: n3.sqrt(y2 * n3.inv(f3)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w3 = e2.adjustScalarBytes || ((y2) => y2), h3 = e2.domain || ((y2, f3, b2) => {
    if (Tt("phflag", b2), f3.length || b2) throw new Error("Contexts/pre-hash are not supported");
    return y2;
  });
  function g3(y2, f3) {
    ft("coordinate " + y2, f3, G, D2);
  }
  function S(y2) {
    if (!(y2 instanceof d3)) throw new Error("ExtendedPoint expected");
  }
  const v3 = xe((y2, f3) => {
    const { ex: b2, ey: E3, ez: B } = y2, C2 = y2.is0();
    f3 == null && (f3 = C2 ? wr : n3.inv(B));
    const A = c4(b2 * f3), U = c4(E3 * f3), _2 = c4(B * f3);
    ...
    const { ex: E3, ey: B, ez: C2, et: A } = y2, U = c4(E3 * E3), _2 = c4(B * B), T2 = c4(C2 * C2), $ = c4(T2 * T2), R = c4(U * f3), V = c4(T2 * c4(R + _2)), Y = c4($ + c4(b2 * c4(U * _2)));
    if (V !== Y) throw new Error("bad point: equation left != right (1)");
    const Z = c4(E3 * B), X = c4(C2 * A);
    if (Z !== X) throw new Error("bad point: equation left != right (2)");
    return true;
  });
  class d3 {
    constructor(f3, b2, E3, B) {
      this.ex = f3, this.ey = b2, this.ez = E3, this.et = B, g3("x", f3), g3("y", b2), g3("z", E3), g3("t", B), Object.freeze(this);
    }
    get x() {
    ...
    static fromAffine(f3) {
      ...
      const { x: b2, y: E3 } = f3 || {};
      return g3("x", b2), g3("y", E3), new d3(b2, E3, j, c4(b2 * E3));
    }
    static normalizeZ(f3) {
      const b2 = n3.invertBatch(f3.map((E3) => E3.ez));
      return f3.map((E3, B) => E3.toAffine(b2[B])).map(d3.fromAffine);
    }
    static msm(f3, b2) {
      return br(d3, l5, f3, b2);
    }
    _setWindowSize(f3) {
    ...
    equals(f3) {
      S(f3);
      const { ex: b2, ey: E3, ez: B } = this, { ex: C2, ey: A, ez: U } = f3, _2 = c4(b2 * U), T2 = c4(C2 * B), $ = c4(E3 * U), R = c4(A * B);
      return _2 === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f3 } = e2, { ex: b2, ey: E3, ez: B } = this, C2 = c4(b2 * b2), A = c4(E3 * E3), U = c4(yt * c4(B * B)), _2 = c4(f3 * C2), T2 = b2 + E3, $ = c4(c4(T2 * T2) - C2 - A), R = _2 + A, V = R - U, Y = _2 - A, Z = c4($ * V), X = c4(R * Y), et = c4($ * Y), pt = c4(V * R);
      return new d3(Z, X, pt, et);
    }
    add(f3) {
      S(f3);
      const { a: b2, d: E3 } = e2, { ex: B, ey: C2, ez: A, et: U } = this, { ex: _2, ey: T2, ez: $, et: R } = f3;
      if (b2 === BigInt(-1)) {
        const re = c4((C2 - B) * (T2 + _2)), oe = c4((C2 + B) * (T2 - _2)), mt = c4(oe - re);
        if (mt === G) return this.double();
        const se = c4(A * yt * R), ie = c4(U * yt * $), ue = ie + se, ce = oe + re, ae = ie - se, Dn = c4(ue * mt), dn = c4(ce * ae), hn = c4(ue * ae), ln = c4(mt * ce);
        return new d3(Dn, dn, ln, hn);
      }
      const V = c4(B * _2), Y = c4(C2 * T2), Z = c4(U * E3 * R), X = c4(A * $), et = c4((B + C2) * (_2 + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c4(Y - b2 * V), un = c4(et * pt), cn = c4(ee * ne), an = c4(et * ne), fn = c4(pt * ee);
    ...
    multiply(f3) {
      const b2 = f3;
      ft("scalar", b2, j, r3);
      const { p: E3, f: B } = this.wNAF(b2);
      return d3.normalizeZ([E3, B])[0];
    }
    multiplyUnsafe(f3, b2 = d3.ZERO) {
      const E3 = f3;
      return ft("scalar", E3, G, r3), E3 === G ? F : this.is0() || E3 === j ? this : q.wNAFCachedUnsafe(this, E3, d3.normalizeZ, b2);
    }
    isSmallOrder() {
    ...
    static fromHex(f3, b2 = false) {
      const { d: E3, a: B } = e2, C2 = n3.BYTES;
      f3 = W("pointHex", f3, C2), Tt("zip215", b2);
      const A = f3.slice(), U = f3[C2 - 1];
      A[C2 - 1] = U & -129;
      const _2 = Et(A), T2 = b2 ? D2 : n3.ORDER;
      ft("pointHex.y", _2, G, T2);
      const $ = c4(_2 * _2), R = c4($ - j), V = c4(E3 * $ - B);
      ...
      return et !== X && (Z = c4(-Z)), d3.fromAffine({ x: Z, y: _2 });
    }
  ...
  d3.BASE = new d3(e2.Gx, e2.Gy, j, c4(e2.Gx * e2.Gy)), d3.ZERO = new d3(G, j, j, G);
  ...
  function O3(y2) {
    ...
    const b2 = W("hashed private key", s2(y2), 2 * f3), E3 = w3(b2.slice(0, f3)), B = b2.slice(f3, 2 * f3), C2 = I(E3), A = m2.multiply(C2), U = A.toRawBytes();
    return { head: E3, prefix: B, scalar: C2, point: A, pointBytes: U };
  }
  function ot(y2) {
  ...
  function tt(y2 = new Uint8Array(), ...f3) {
    const b2 = ye(...f3);
    return I(s2(h3(b2, W("context", y2), !!o5)));
  }
  function st(y2, f3, b2 = {}) {
    y2 = W("message", y2), o5 && (y2 = o5(y2));
    const { prefix: E3, scalar: B, pointBytes: C2 } = O3(f3), A = tt(b2.context, E3, y2), U = m2.multiply(A).toRawBytes(), _2 = tt(b2.context, U, C2, y2), T2 = z2(A + _2 * B);
  ...
  function Ct(y2, f3, b2, E3 = at) {
    const { context: B, zip215: C2 } = E3, A = n3.BYTES;
    y2 = W("signature", y2, 2 * A), f3 = W("message", f3), b2 = W("publicKey", b2, A), C2 !== void 0 && Tt("zip215", C2), o5 && (f3 = o5(f3));
    const U = Et(y2.slice(A, 2 * A));
    let _2, T2, $;
    try {
      _2 = d3.fromHex(b2, C2), T2 = d3.fromHex(y2.slice(0, A), C2), $ = m2.multiplyUnsafe(U);
    } catch {
      return false;
    }
    if (!C2 && _2.isSmallOrder()) return false;
    const R = tt(B, T2.toRawBytes(), _2.toRawBytes(), f3);
    return T2.add(_2.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d3.ZERO);
  }
  return m2._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d3, utils: { getExtendedPublicKey: O3, randomPrivateKey: () => a2(n3.BYTES), precompute(y2 = 8, f3 = d3.BASE) {
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n3 = BigInt(20), r3 = BigInt(40), o5 = BigInt(80), s2 = kt, u = t * t % s2 * t % s2, i2 = J(u, Te, s2) * u % s2, D2 = J(i2, xr, s2) * t % s2, c4 = J(D2, Br, s2) * D2 % s2, l5 = J(c4, e2, s2) * c4 % s2, p2 = J(l5, n3, s2) * l5 % s2, w3 = J(p2, r3, s2) * p2 % s2, h3 = J(w3, o5, s2) * w3 % s2, g3 = J(h3, o5, s2) * w3 % s2, S = J(g3, e2, s2) * c4 % s2;
...
function _r(t, e2) {
  ...
  let a2 = H(t * r3 * s2, n3);
  const u = H(e2 * a2 * a2, n3), i2 = a2, D2 = H(a2 * Ue, n3), c4 = u === t, l5 = u === H(-t, n3), p2 = u === H(-t * Ue, n3);
  return c4 && (a2 = i2), (l5 || p2) && (a2 = D2), ur(a2, n3) && (a2 = H(-a2, n3)), { isValid: c4 || l5, value: a2 };
}
...
function Ir(t, e2) {
  ...
  var u = t.length, i2 = t.charAt(0), D2 = Math.log(u) / Math.log(256), c4 = Math.log(256) / Math.log(u);
  function l5(h3) {
    ...
    for (var g3 = 0, S = 0, v3 = 0, L2 = h3.length; v3 !== L2 && h3[v3] === 0; ) v3++, g3++;
    for (var d3 = (L2 - v3) * c4 + 1 >>> 0, m2 = new Uint8Array(d3); v3 !== L2; ) {
      for (var F = h3[v3], q = 0, z2 = d3 - 1; (F !== 0 || q < S) && z2 !== -1; z2--, q++) F += 256 * m2[z2] >>> 0, m2[z2] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0) throw new Error("Non-zero carry");
      S = q, v3++;
    }
    for (var I = d3 - S; I !== d3 && m2[I] === 0; ) I++;
    for (var O3 = i2.repeat(g3); I < d3; ++I) O3 += t.charAt(m2[I]);
    return O3;
  }
  function p2(h3) {
    ...
    var g3 = 0;
    if (h3[g3] !== " ") {
      for (var S = 0, v3 = 0; h3[g3] === i2; ) S++, g3++;
      for (var L2 = (h3.length - g3) * D2 + 1 >>> 0, d3 = new Uint8Array(L2); h3[g3]; ) {
        var m2 = n3[h3.charCodeAt(g3)];
        if (m2 === 255) return;
      ...
      if (h3[g3] !== " ") {
        for (var z2 = L2 - v3; z2 !== L2 && d3[z2] === 0; ) z2++;
        for (var I = new Uint8Array(S + (L2 - z2)), O3 = S; z2 !== L2; ) I[O3++] = d3[z2++];
        return I;
      }
    }
  }
  ...
  return { encode: l5, decodeUnsafe: p2, decode: w3 };
}
var Ur = Ir;
var Tr = Ur;
var He = (t) => {
...
var Mr = (t, e2, n3, r3) => {
  ...
  for (let c4 = 0; c4 < s2; ++c4) {
    ...
    i2 = i2 << n3 | l5, u += n3, u >= 8 && (u -= 8, a2[D2++] = 255 & i2 >> u);
  }
...
async function Qo(t, e2, n3, r3, o5 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s2 = { alg: jt, typ: Zt }, a2 = Qe(r3.publicKey), u = o5 + n3, i2 = { iss: a2, sub: t, aud: e2, iat: o5, exp: u }, D2 = rn({ header: s2, payload: i2 }), c4 = Rt.sign(D2, r3.secretKey.slice(0, 32));
  return on({ header: s2, payload: i2, signature: c4 });
}
...
// ../../node_modules/.pnpm/@walletconnect+jsonrpc-http-connection@1.0.8_encoding@0.1.13/node_modules/@walletconnect/jsonrpc-http-connection/dist/index.es.js
...
var alphabetBytesToChars = alphabet.reduce((p2, c4, i2) => {
  p2[i2] = c4;
  return p2;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p2, c4, i2) => {
  p2[c4.codePointAt(0)] = i2;
  return p2;
}, []);
...
// ../../node_modules/.pnpm/@walletconnect+keyvaluestorage@1.1.1_@react-native-async-storage+async-storage@1.24.0_react-n_mu22xslu4upymq6xoc6wrqi5y4/node_modules/@walletconnect/keyvaluestorage/dist/index.es.js
var import_dist139 = __toESM(require_dist());
var import_dist140 = __toESM(require_dist2());
var import_dist141 = __toESM(require_dist3());

// ../../node_modules/.pnpm/unstorage@1.17.4_idb-keyval@6.2.2/node_modules/unstorage/dist/index.mjs
...
// ../../node_modules/.pnpm/unstorage@1.17.4_idb-keyval@6.2.2/node_modules/unstorage/dist/shared/unstorage.zVDD2mZo.mjs
...
var O2 = async (i2, t, e2) => {
  ...
  for (; a2.length; ) {
    ...
    if (o5.includes("wc@") || o5.includes("walletconnect") || o5.includes("wc_") || o5.includes("wallet_connect")) {
      const f3 = await i2.getItem(r3);
      await t.setItem(r3, f3), m2.push(r3);
    }
  }
  await t.setItem(n3, y), e2(t), j3(i2, m2);
};
var j3 = async (i2, t) => {
...
// ../../node_modules/.pnpm/@walletconnect+jsonrpc-ws-connection@1.0.16_bufferutil@4.1.0_utf-8-validate@5.0.10/node_modules/@walletconnect/jsonrpc-ws-connection/dist/index.es.js
...
*/
//# sourceMappingURL=chunk-TZIC4LXU.js.map
