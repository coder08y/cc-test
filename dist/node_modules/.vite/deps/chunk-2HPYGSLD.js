...
import {
  ...
  tuple,
  union
} from "./chunk-JYUGIMDE.js";
import {
  esm_default
} from "./chunk-2CHWK2DL.js";
import {
  init_legacy
} from "./chunk-7VJRFS4I.js";
import {
  init_sha256,
  sha256
...
// ../../node_modules/.pnpm/@noble+hashes@1.8.0/node_modules/@noble/hashes/esm/sha1.js
...
function base_default(checksumFn) {
  function encode20(payload) {
    ...
    return esm_default.encode(both);
  }
  ...
  function decodeUnsafe(str) {
    var buffer = esm_default.decodeUnsafe(str);
    if (buffer == null)
      return;
    return decodeRaw(buffer);
  }
  function decode19(str) {
    var buffer = esm_default.decode(str);
...
var esm_default2 = base_default(sha256x2);
...
function p2pkh(a, opts) {
  ...
  const _address = value(() => {
    const payload = esm_default2.decode(a.address);
  ...
  prop(o, "address", () => {
    ...
    return esm_default2.encode(payload);
  });
  prop(o, "hash", () => {
...
init_sha256();
var import_bech322 = __toESM(require_dist4(), 1);
var OPS8 = OPS;
...
// ../../node_modules/.pnpm/bitcoinjs-lib@7.0.1_typescript@5.9.3/node_modules/bitcoinjs-lib/src/esm/payments/p2tr.js
var import_bech323 = __toESM(require_dist4(), 1);
var OPS9 = OPS;
...
// ../../node_modules/.pnpm/bitcoinjs-lib@7.0.1_typescript@5.9.3/node_modules/bitcoinjs-lib/src/esm/address.js
var import_bech324 = __toESM(require_dist4(), 1);
...
function fromBase58Check(address) {
  const payload = esm_default2.decode(address);
...
//# sourceMappingURL=chunk-2HPYGSLD.js.map
