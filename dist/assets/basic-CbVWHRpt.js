import{eY as g,fO as A,cZ as v,fP as S,fQ as b,fR as p,cW as Oe,eZ as l,fS as O,fT as h,fU as R,fV as Be,fW as ot,fX as K,fY as rt,cS as N,fZ as D,f_ as oe,f$ as be,g0 as he,g1 as He,g2 as Ke,g3 as Qe,g4 as st,g5 as Ge,cu as ge,g6 as at,g7 as lt,g8 as ct,eX as Xe,g9 as Ie}from"./index-By8Hp4ew.js";import{n as c,r as d,o as y}from"./class-map-0sevUfiO.js";import{c as f,U as V,n as dt}from"./index-BMOeRXMr.js";import{b as ut,e as Pe,n as je}from"./ref-DvHSGeOZ.js";import"./vendor-ZyUzGBZZ.js";import"./cross-DUJvGYa4.js";import"./dijkstra-D_NXgYpA.js";import"./async-directive-D8v_o4Ev.js";var ce=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Z=class extends g{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=A.state.connectors,this.count=v.state.count,this.filteredCount=v.state.filteredWallets.length,this.isFetchingRecommendedWallets=v.state.isFetchingRecommendedWallets,this.unsubscribe.push(A.subscribeKey("connectors",e=>this.connectors=e),v.subscribeKey("count",e=>this.count=e),v.subscribeKey("filteredWallets",e=>this.filteredCount=e.length),v.subscribeKey("isFetchingRecommendedWallets",e=>this.isFetchingRecommendedWallets=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.connectors.find(C=>C.id==="walletConnect"),{allWallets:i}=S.state;if(!e||i==="HIDE"||i==="ONLY_MOBILE"&&!b.isMobile())return null;const o=v.state.featured.length,r=this.count+o,n=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:n;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const u=p.hasAnyConnection(Oe.CONNECTOR_ID.WALLET_CONNECT);return l`
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
        ...
        size="sm"
      ></wui-list-wallet>
    `}onAllWallets(){var e;O.sendEvent({type:"track",event:"CLICK_ALL_WALLETS"}),h.push("AllWallets",{redirectView:(e=h.state.data)==null?void 0:e.redirectView})}};ce([c()],Z.prototype,"tabIdx",void 0);ce([d()],Z.prototype,"connectors",void 0);ce([d()],Z.prototype,"count",void 0);ce([d()],Z.prototype,"filteredCount",void 0);ce([d()],Z.prototype,"isFetchingRecommendedWallets",void 0);Z=ce([f("w3m-all-wallets-widget")],Z);const ht=R`
  :host {
...
`;var pe=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(r<3?s(n):r>3?s(e,i,n):s(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};const ft={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},wt={lg:"md",md:"sm",sm:"sm"};let J=class extends g{constructor(){super(...arguments),this.icon="mobile",this.size="md",this.label="",this.active=!1}render(){return l`
      <button data-active=${this.active}>
        ${this.icon?l`<wui-icon size=${wt[this.size]} name=${this.icon}></wui-icon>`:""}
        <wui-text variant=${ft[this.size]}> ${this.label} </wui-text>
      </button>
    `}};J.styles=[D,oe,pt];pe([c()],J.prototype,"icon",void 0);pe([c()],J.prototype,"size",void 0);pe([c()],J.prototype,"label",void 0);pe([c({type:Boolean})],J.prototype,"active",void 0);J=pe([f("wui-tab-item")],J);const mt=R`
  :host {
    display: inline-flex;
    align-items: center;
