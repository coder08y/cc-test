...
<<<<<<<< HEAD:dist/assets/index-Bi40jVbS.js
import{dl as G,eV as $,dm as y,dn as h,ap as d,fj as p,eU as L,eW as W}from"./index-ByUtbMXc.js";import{n as l,a as ee,o as V}from"./class-map-Bc8mD0AA.js";import{_ as c}from"./cross-MVfrlKDn.js";const D=".",S={getSpacingStyles(e,t){if(Array.isArray(e))return e[t]?`var(--apkt-spacing-${e[t]})`:void 0;if(typeof e=="string")return`var(--apkt-spacing-${e})`},getFormattedDate(e){return new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(e)},formatCurrency(e=0,t={}){const o=Number(e);return isNaN(o)?"$0.00":new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2,...t}).format(o)},getHostName(e){try{return new URL(e).hostname}catch{return""}},getTruncateString({string:e,charsStart:t,charsEnd:o,truncate:r}){return e.length<=t+o?e:r==="end"?`${e.substring(0,t)}...`:r==="start"?`...${e.substring(e.length-o)}`:`${e.substring(0,Math.floor(t))}...${e.substring(e.length-Math.floor(o))}`},generateAvatarColors(e){const o=e.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),r=this.hexToRgb(o),n=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),a=100-3*Number(n==null?void 0:n.replace("px","")),s=`${a}% ${a}% at 65% 40%`,w=[];for(let m=0;m<5;m+=1){const P=this.tintColor(r,.15*m);w.push(`rgb(${P[0]}, ${P[1]}, ${P[2]})`)}return`
    --local-color-1: ${w[0]};
    --local-color-2: ${w[1]};
    --local-color-3: ${w[2]};
    --local-color-4: ${w[3]};
    --local-color-5: ${w[4]};
========
import{dj as q,eV as w,dk as $,dl as h,ax as d,eX as p,eU as x,eW as Z}from"./index-CzEY8khk.js";import{n as l,a as ie,o as R}from"./class-map-D47vqpIj.js";import{_ as c}from"./cross-UyvHgEs3.js";const j=".",z={getSpacingStyles(e,t){if(Array.isArray(e))return e[t]?`var(--apkt-spacing-${e[t]})`:void 0;if(typeof e=="string")return`var(--apkt-spacing-${e})`},getFormattedDate(e){return new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(e)},formatCurrency(e=0,t={}){const o=Number(e);return isNaN(o)?"$0.00":new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2,...t}).format(o)},getHostName(e){try{return new URL(e).hostname}catch{return""}},getTruncateString({string:e,charsStart:t,charsEnd:o,truncate:r}){return e.length<=t+o?e:r==="end"?`${e.substring(0,t)}...`:r==="start"?`...${e.substring(e.length-o)}`:`${e.substring(0,Math.floor(t))}...${e.substring(e.length-Math.floor(o))}`},generateAvatarColors(e){const o=e.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),r=this.hexToRgb(o),a=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),n=100-3*Number(a==null?void 0:a.replace("px","")),s=`${n}% ${n}% at 65% 40%`,_=[];for(let v=0;v<5;v+=1){const S=this.tintColor(r,.15*v);_.push(`rgb(${S[0]}, ${S[1]}, ${S[2]})`)}return`
    --local-color-1: ${_[0]};
    --local-color-2: ${_[1]};
    --local-color-3: ${_[2]};
    --local-color-4: ${_[3]};
    --local-color-5: ${_[4]};
>>>>>>>> fbb2e9029f05f00136e90351b9cd72fadc3ba779:dist/assets/index-DLWFUCO0.js
    --local-radial-circle: ${s}
   `},hexToRgb(e){const t=parseInt(e,16),o=t>>16&255,r=t>>8&255,a=t&255;return[o,r,a]},tintColor(e,t){const[o,r,a]=e,i=Math.round(o+(255-o)*t),n=Math.round(r+(255-r)*t),s=Math.round(a+(255-a)*t);return[i,n,s]},isNumber(e){return{number:/^[0-9]+$/u}.number.test(e)},getColorTheme(e){var t;return e||(typeof window<"u"&&window.matchMedia&&typeof window.matchMedia=="function"?(t=window.matchMedia("(prefers-color-scheme: dark)"))!=null&&t.matches?"dark":"light":"dark")},splitBalance(e){const t=e.split(".");return t.length===2?[t[0],t[1]]:["0","00"]},roundNumber(e,t,o){return e.toString().length>=t?Number(e).toFixed(o):e},cssDurationToNumber(e){return e.endsWith("s")?Number(e.replace("s",""))*1e3:e.endsWith("ms")?Number(e.replace("ms","")):0},maskInput({value:e,decimals:t,integers:o}){if(e=e.replace(",","."),e===j)return`0${j}`;const[r="",a]=e.split(j).map(S=>S.replace(/[^0-9]/gu,"")),i=o?r.substring(0,o):r,n=i.length===2?String(Number(i)):i,s=typeof t=="number"?a==null?void 0:a.substring(0,t):a,_=typeof t!="number"||t>0;return(typeof s=="string"&&_?[n,s].join(j):n)??""},capitalize(e){return e?e.charAt(0).toUpperCase()+e.slice(1):""}};function oe(e,t){const{kind:o,elements:r}=t;return{kind:o,elements:r,finisher(a){customElements.get(e)||customElements.define(e,a)}}}function re(e,t){return customElements.get(e)||customElements.define(e,t),t}function b(e){return function(o){return typeof o=="function"?re(e,o):oe(e,o)}}const ae=q`
  :host {
    display: flex;
    width: inherit;
    height: inherit;
...
`;var f=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let u=class extends ${render(){return this.style.cssText=`
      ...
      width: ${this.width};
    `,h`<slot></slot>`}};u.styles=[w,ae];f([l()],u.prototype,"flexDirection",void 0);f([l()],u.prototype,"flexWrap",void 0);f([l()],u.prototype,"flexBasis",void 0);f([l()],u.prototype,"flexGrow",void 0);f([l()],u.prototype,"flexShrink",void 0);f([l()],u.prototype,"alignItems",void 0);f([l()],u.prototype,"justifyContent",void 0);f([l()],u.prototype,"columnGap",void 0);f([l()],u.prototype,"rowGap",void 0);f([l()],u.prototype,"gap",void 0);f([l()],u.prototype,"padding",void 0);f([l()],u.prototype,"margin",void 0);f([l()],u.prototype,"width",void 0);u=f([b("wui-flex")],u);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ee=Symbol.for(""),ne=e=>{if((e==null?void 0:e.r)===ee)return e==null?void 0:e._$litStatic$},le=e=>({_$litStatic$:e,r:ee}),J=new Map,se=e=>(t,...o)=>{const r=o.length;let a,i;const n=[],s=[];let _,v=0,S=!1;for(;v<r;){for(_=t[v];v<r&&(i=o[v],(a=ne(i))!==void 0);)_+=a+t[++v],S=!0;v!==r&&s.push(i),n.push(_),v++}if(v===r&&n.push(t[r]),S){const Y=n.join("$$lit$$");(t=J.get(Y))===void 0&&(n.raw=n,J.set(Y,t=n)),o=s}return e(t,...o)},K=se(h),ce=d`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
</svg>`,he=d`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
</svg>`,ue=d` <svg fill="none" viewBox="0 0 13 4">
...
</svg>`,me=d`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
...
</svg>`,we=d`<svg style="border-radius: 9999px; overflow: hidden;"  fill="none" viewBox="0 0 1000 1000">
...
</svg>`,ye=d`<svg width="75" height="20" viewBox="0 0 75 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,Pe=d`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
`,Q=d`<svg fill="none" viewBox="0 0 41 40">
  <g clip-path="url(#a)">
...
`;var B=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let I=class extends ${constructor(){super(...arguments),this.icon="copy",this.size="md",this.padding="1",this.color="default"}render(){return this.dataset.padding=this.padding,this.dataset.color=this.color,h`
      <wui-icon size=${R(this.size)} name=${this.icon} color="inherit"></wui-icon>
    `}};I.styles=[w,Z,De];B([l()],I.prototype,"icon",void 0);B([l()],I.prototype,"size",void 0);B([l()],I.prototype,"padding",void 0);B([l()],I.prototype,"color",void 0);I=B([b("wui-icon-box")],I);const Be=x`
  :host {
    display: block;
    width: var(--local-width);
...
`;var C=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let y=class extends ${constructor(){super(...arguments),this.src="./path/to/image.jpg",this.alt="Image",this.size=void 0,this.boxed=!1,this.rounded=!1,this.fullSize=!1}render(){const t={inherit:"inherit",xxs:"2",xs:"3",sm:"4",md:"4",mdl:"5",lg:"5",xl:"6",xxl:"7","3xl":"8","4xl":"9","5xl":"10"};return this.style.cssText=`
      ...
      `,this.dataset.boxed=this.boxed?"true":"false",this.dataset.rounded=this.rounded?"true":"false",this.dataset.full=this.fullSize?"true":"false",this.dataset.icon=this.iconColor||"inherit",this.icon?h`<wui-icon
        ...
        name=${this.icon}
        size="lg"
      ></wui-icon> `:this.logo?h`<wui-icon size="lg" color="inherit" name=${this.logo}></wui-icon> `:h`<img src=${R(this.src)} alt=${this.alt} @error=${this.handleImageError} />`}handleImageError(){this.dispatchEvent(new CustomEvent("onLoadError",{bubbles:!0,composed:!0}))}};y.styles=[w,Be];C([l()],y.prototype,"src",void 0);C([l()],y.prototype,"logo",void 0);C([l()],y.prototype,"icon",void 0);C([l()],y.prototype,"iconColor",void 0);C([l()],y.prototype,"alt",void 0);C([l()],y.prototype,"size",void 0);C([l({type:Boolean})],y.prototype,"boxed",void 0);C([l({type:Boolean})],y.prototype,"rounded",void 0);C([l({type:Boolean})],y.prototype,"fullSize",void 0);y=C([b("wui-image")],y);const We=x`
  :host {
    position: relative;
...
`;var H=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let L=class extends ${constructor(){super(...arguments),this.size="md",this.name="",this.installed=!1,this.badgeSize="xs"}render(){let t="1";return this.size==="lg"?t="4":this.size==="md"?t="2":this.size==="sm"&&(t="1"),this.style.cssText=`
   ...
   `,this.dataset.size=this.size,this.imageSrc&&(this.dataset.image="true"),this.walletIcon&&(this.dataset.walletIcon=this.walletIcon),h`
    ...
    `}templateVisual(){return this.imageSrc?h`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:this.walletIcon?h`<wui-icon size="md" color="default" name=${this.walletIcon}></wui-icon>`:h`<wui-icon
      ...
      color="inherit"
      name="wallet"
    ></wui-icon>`}};L.styles=[w,We];H([l()],L.prototype,"size",void 0);H([l()],L.prototype,"name",void 0);H([l()],L.prototype,"imageSrc",void 0);H([l()],L.prototype,"walletIcon",void 0);H([l({type:Boolean})],L.prototype,"installed",void 0);H([l()],L.prototype,"badgeSize",void 0);L=H([b("wui-wallet-image")],L);const je=x`
  :host {
    position: relative;
    border-radius: ${({borderRadius:e})=>e[2]};
    width: 40px;
...
`;var te=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const N=4;let F=class extends ${constructor(){super(...arguments),this.walletImages=[]}render(){const t=this.walletImages.length<N;return h`${this.walletImages.slice(0,N).map(({src:o,walletName:r})=>h`
          ...
          ></wui-wallet-image>
        `)}
    ${t?[...Array(N-this.walletImages.length)].map(()=>h` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};F.styles=[w,je];te([l({type:Array})],F.prototype,"walletImages",void 0);F=te([b("wui-all-wallets-image")],F);const Fe=x`
  :host {
    display: flex;
    justify-content: center;
    align-items: center;
...
`;var U=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let O=class extends ${constructor(){super(...arguments),this.variant="accent",this.size="md",this.icon=void 0}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;const t=this.size==="md"?"md-medium":"sm-medium",o=this.size==="md"?"md":"sm";return h`
    ...
    `}};O.styles=[w,Fe];U([l()],O.prototype,"variant",void 0);U([l()],O.prototype,"size",void 0);U([l()],O.prototype,"icon",void 0);O=U([b("wui-tag")],O);const Ue=x`
  :host {
    width: 100%;
  }
...
`;var m=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const Ne={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton"};let g=class extends ${constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,h`
      <button
    ...
    `}templateNamespaces(){var t;return(t=this.namespaces)!=null&&t.length?h`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((o,r)=>{var a;return h`<wui-flex
              alignItems="center"
        ...
        name=${this.name}
      ></wui-wallet-image>`:!this.showAllWallets&&!this.imageSrc?h`<wui-wallet-image size="sm" name=${this.name}></wui-wallet-image>`:null}templateStatus(){return this.loading?h`<wui-loading-spinner size="lg" color="accent-primary"></wui-loading-spinner>`:this.tagLabel&&this.tagVariant?h`<wui-tag size="sm" variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`:null}};g.styles=[w,Z,Ue];m([l({type:Array})],g.prototype,"walletImages",void 0);m([l()],g.prototype,"imageSrc",void 0);m([l()],g.prototype,"name",void 0);m([l()],g.prototype,"size",void 0);m([l()],g.prototype,"tagLabel",void 0);m([l()],g.prototype,"tagVariant",void 0);m([l()],g.prototype,"walletIcon",void 0);m([l()],g.prototype,"tabIdx",void 0);m([l({type:Array})],g.prototype,"namespaces",void 0);m([l({type:Boolean})],g.prototype,"disabled",void 0);m([l({type:Boolean})],g.prototype,"showAllWallets",void 0);m([l({type:Boolean})],g.prototype,"loading",void 0);m([l({type:String})],g.prototype,"loadingSpinnerColor",void 0);g=m([b("wui-list-wallet")],g);const Ge=q`
  :host {
    display: flex;
  }
...
`;var X=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let M=class extends ${constructor(){super(...arguments),this.color="primary",this.size="lg"}render(){const t={primary:p.tokens.theme.textPrimary,secondary:p.tokens.theme.textSecondary,tertiary:p.tokens.theme.textTertiary,invert:p.tokens.theme.textInvert,error:p.tokens.core.textError,warning:p.tokens.core.textWarning,"accent-primary":p.tokens.core.textAccentPrimary};return this.style.cssText=`
      ...
      <path
        ...
        fill="currentColor"
      />
    </svg>`}};M.styles=[w,Ge];X([l()],M.prototype,"color",void 0);X([l()],M.prototype,"size",void 0);M=X([b("wui-loading-spinner")],M);const qe=x`
  :host {
    width: var(--local-width);
  }
...
`;var V=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const Xe={lg:"lg-regular-mono",md:"md-regular-mono",sm:"sm-regular-mono"},Ye={lg:"md",md:"md",sm:"sm"};let P=class extends ${constructor(){super(...arguments),this.size="lg",this.disabled=!1,this.fullWidth=!1,this.loading=!1,this.variant="accent-primary"}render(){this.style.cssText=`
    --local-width: ${this.fullWidth?"100%":"auto"};
     `;const t=this.textVariant??Xe[this.size];return h`
    ...
    `}loadingTemplate(){if(this.loading){const t=Ye[this.size],o=this.variant==="neutral-primary"||this.variant==="accent-primary"?"invert":"primary";return h`<wui-loading-spinner color=${o} size=${t}></wui-loading-spinner>`}return null}};P.styles=[w,Z,qe];V([l()],P.prototype,"size",void 0);V([l({type:Boolean})],P.prototype,"disabled",void 0);V([l({type:Boolean})],P.prototype,"fullWidth",void 0);V([l({type:Boolean})],P.prototype,"loading",void 0);V([l()],P.prototype,"variant",void 0);V([l()],P.prototype,"textVariant",void 0);P=V([b("wui-button")],P);const Je=x`
  button {
    border: none;
...
`;var W=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const Ke={sm:"sm-medium",md:"md-medium"},Qe={accent:"accent-primary",secondary:"secondary"};let A=class extends ${constructor(){super(...arguments),this.size="md",this.disabled=!1,this.variant="accent",this.icon=void 0}render(){return h`
      <button ?disabled=${this.disabled} data-variant=${this.variant}>
        <slot name="iconLeft"></slot>
        <wui-text
          color=${Qe[this.variant]}
          variant=${Ke[this.size]}
        >
          <slot></slot>
        </wui-text>
        ${this.iconTemplate()}
      </button>
    `}iconTemplate(){return this.icon?h`<wui-icon name=${this.icon} size="sm"></wui-icon>`:null}};A.styles=[w,Z,Je];W([l()],A.prototype,"size",void 0);W([l({type:Boolean})],A.prototype,"disabled",void 0);W([l()],A.prototype,"variant",void 0);W([l()],A.prototype,"icon",void 0);A=W([b("wui-link")],A);const et="https://reown.com",tt=x`
  .reown-logo {
    height: 24px;
  }
...
`;var it=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};let G=class extends ${render(){return h`
      <a
    ...
    `}};G.styles=[w,Z,tt];G=it([b("wui-ux-by-reown")],G);export{z as U,b as c};
