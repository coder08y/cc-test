...
`;var F=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let R=class extends m{constructor(){super(...arguments),this.icon="copy",this.size="md",this.padding="1",this.color="default"}render(){return this.dataset.padding=this.padding,this.dataset.color=this.color,h`
    ...
    `}};R.styles=[w,B,qe];F([l()],R.prototype,"icon",void 0);F([l()],R.prototype,"size",void 0);F([l()],R.prototype,"padding",void 0);F([l()],R.prototype,"color",void 0);R=F([v("wui-icon-box")],R);const Xe=L`
  :host {
    display: block;
    width: var(--local-width);
...
`;var P=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let _=class extends m{constructor(){super(...arguments),this.src="./path/to/image.jpg",this.alt="Image",this.size=void 0,this.boxed=!1,this.rounded=!1,this.fullSize=!1}render(){const t={inherit:"inherit",xxs:"2",xs:"3",sm:"4",md:"4",mdl:"5",lg:"5",xl:"6",xxl:"7","3xl":"8","4xl":"9","5xl":"10"};return this.style.cssText=`
      ...
      `,this.dataset.boxed=this.boxed?"true":"false",this.dataset.rounded=this.rounded?"true":"false",this.dataset.full=this.fullSize?"true":"false",this.dataset.icon=this.iconColor||"inherit",this.icon?h`<wui-icon
        ...
        name=${this.icon}
        size="lg"
      ></wui-icon> `:this.logo?h`<wui-icon size="lg" color="inherit" name=${this.logo}></wui-icon> `:h`<img src=${S(this.src)} alt=${this.alt} @error=${this.handleImageError} />`}handleImageError(){this.dispatchEvent(new CustomEvent("onLoadError",{bubbles:!0,composed:!0}))}};_.styles=[w,Xe];P([l()],_.prototype,"src",void 0);P([l()],_.prototype,"logo",void 0);P([l()],_.prototype,"icon",void 0);P([l()],_.prototype,"iconColor",void 0);P([l()],_.prototype,"alt",void 0);P([l()],_.prototype,"size",void 0);P([l({type:Boolean})],_.prototype,"boxed",void 0);P([l({type:Boolean})],_.prototype,"rounded",void 0);P([l({type:Boolean})],_.prototype,"fullSize",void 0);_=P([v("wui-image")],_);const Ye=L`
  :host {
    position: relative;
...
`;var M=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let z=class extends m{constructor(){super(...arguments),this.size="md",this.name="",this.installed=!1,this.badgeSize="xs"}render(){let t="1";return this.size==="lg"?t="4":this.size==="md"?t="2":this.size==="sm"&&(t="1"),this.style.cssText=`
   ...
   `,this.dataset.size=this.size,this.imageSrc&&(this.dataset.image="true"),this.walletIcon&&(this.dataset.walletIcon=this.walletIcon),h`
    ...
    `}templateVisual(){return this.imageSrc?h`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:this.walletIcon?h`<wui-icon size="md" color="default" name=${this.walletIcon}></wui-icon>`:h`<wui-icon
      ...
      color="inherit"
      name="wallet"
    ></wui-icon>`}};z.styles=[w,Ye];M([l()],z.prototype,"size",void 0);M([l()],z.prototype,"name",void 0);M([l()],z.prototype,"imageSrc",void 0);M([l()],z.prototype,"walletIcon",void 0);M([l({type:Boolean})],z.prototype,"installed",void 0);M([l()],z.prototype,"badgeSize",void 0);z=M([v("wui-wallet-image")],z);const Je=L`
  :host {
    position: relative;
    border-radius: ${({borderRadius:e})=>e[2]};
    width: 40px;
...
`;var ne=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};const Y=4;let q=class extends m{constructor(){super(...arguments),this.walletImages=[]}render(){const t=this.walletImages.length<Y;return h`${this.walletImages.slice(0,Y).map(({src:o,walletName:r})=>h`
          <wui-wallet-image
            size="sm"
            imageSrc=${o}
            name=${S(r)}
          ></wui-wallet-image>
        `)}
    ${t?[...Array(Y-this.walletImages.length)].map(()=>h` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};q.styles=[w,Je];ne([l({type:Array})],q.prototype,"walletImages",void 0);q=ne([v("wui-all-wallets-image")],q);const Ke=L`
  :host {
    display: flex;
    justify-content: center;
    align-items: center;
...
`;var X=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let T=class extends m{constructor(){super(...arguments),this.variant="accent",this.size="md",this.icon=void 0}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;const t=this.size==="md"?"md-medium":"sm-medium",o=this.size==="md"?"md":"sm";return h`
    ...
    `}};T.styles=[w,Ke];X([l()],T.prototype,"variant",void 0);X([l()],T.prototype,"size",void 0);X([l()],T.prototype,"icon",void 0);T=X([v("wui-tag")],T);const Qe=L`
  :host {
    width: 100%;
  }
...
`;var Q=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let W=class extends m{constructor(){super(...arguments),this.color="primary",this.size="lg"}render(){const t={primary:p.tokens.theme.textPrimary,secondary:p.tokens.theme.textSecondary,tertiary:p.tokens.theme.textTertiary,invert:p.tokens.theme.textInvert,error:p.tokens.core.textError,warning:p.tokens.core.textWarning,"accent-primary":p.tokens.core.textAccentPrimary};return this.style.cssText=`
      ...
      <path
        ...
        fill="currentColor"
      />
    </svg>`}};W.styles=[w,tt];Q([l()],W.prototype,"color",void 0);Q([l()],W.prototype,"size",void 0);W=Q([v("wui-loading-spinner")],W);const it=L`
  :host {
    width: var(--local-width);
  }
