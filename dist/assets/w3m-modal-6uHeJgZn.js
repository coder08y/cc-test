import{eL as v,eM as f,eN as a}from"./index-CqnAI54H.js";import{n as w,r as d,o as q}from"./class-map-CRMI_rW3.js";import{w as ve,s as fe,a as ge,p as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-BeAbBZ_g.js";import{c as u,U as We}from"./index-BUsf8v4e.js";import"./vendor-BZDKgC6c.js";import"./cross-DFLdrXOg.js";import"./index.es-C8449ogN.js";import"./async-directive-Bc8j5BcX.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},N=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
...
`;var _=function(r,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,o);else for(var c=r.length-1;c>=0;c--)(s=r[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let W=class extends f{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`
   ...
   `,a`
    ...
    `}onClose(){K.close()}};W.styles=[P,Te];_([w()],W.prototype,"message",void 0);_([w()],W.prototype,"backgroundColor",void 0);_([w()],W.prototype,"iconColor",void 0);_([w()],W.prototype,"icon",void 0);W=_([u("wui-alertbar")],W);const Ne=v`
  :host {
    display: block;
    position: absolute;
