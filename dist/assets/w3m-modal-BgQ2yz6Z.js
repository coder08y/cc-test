import{eA as v,eB as f,eC as a}from"./index-Byldhfb1.js";import{n as w,r as d,o as q}from"./class-map-XoYVUQFr.js";import{w as ve,s as fe,a as ge,p as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-DMLndKPV.js";import{c as u,U as We}from"./index-B63iWOAJ.js";import"./vendor-2I7_sm6u.js";import"./cross-BVHasebI.js";import"./index.es-o5prBVAG.js";import"./async-directive-DuuLuzgF.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},Ae=v`
  :host {
    display: block;
...
`;var $e=function(r,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,o);else for(var c=r.length-1;c>=0;c--)(s=r[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let J=class extends f{render(){return a`<slot></slot>`}};J.styles=[P,Ae];J=$e([u("wui-card")],J);const Te=v`
  :host {
    display: flex;
    align-items: center;
...
`;var $=function(r,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,o);else for(var c=r.length-1;c>=0;c--)(s=r[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let b=class extends f{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return a`
    ...
    `}templateIcon(){return this.loading?a`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:this.iconType==="default"?a`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:a`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};b.styles=[P,Be];$([w()],b.prototype,"backgroundColor",void 0);$([w()],b.prototype,"iconColor",void 0);$([w()],b.prototype,"icon",void 0);$([w()],b.prototype,"message",void 0);$([w()],b.prototype,"loading",void 0);$([w()],b.prototype,"iconType",void 0);b=$([u("wui-snackbar")],b);const De=v`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var D=function(r,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,e,t,o);else for(var c=r.length-1;c>=0;c--)(s=r[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let A=class extends f{constructor(){super(),this.unsubscribe=[],this.open=O.state.open,this.message=O.state.message,this.triggerRect=O.state.triggerRect,this.variant=O.state.variant,this.unsubscribe.push(O.subscribe(e=>{this.open=e.open,this.message=e.message,this.triggerRect=e.triggerRect,this.variant=e.variant}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){this.dataset.variant=this.variant;const e=this.triggerRect.top,t=this.triggerRect.left;return this.style.cssText=`
    ...
    </wui-flex>`}};A.styles=[Le];D([d()],A.prototype,"open",void 0);D([d()],A.prototype,"message",void 0);D([d()],A.prototype,"triggerRect",void 0);D([d()],A.prototype,"variant",void 0);A=D([u("w3m-tooltip"),u("w3m-tooltip")],A);const Ue=v`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
    display: block;
