<<<<<<<< HEAD:dist/assets/w3m-modal-BJWTIByI.js
import{dl as v,dm as f,dn as a}from"./index-COsYtIaE.js";import{n as w,r as d,o as q}from"./class-map-nFFRZNA3.js";import{w as ve,p as fe,s as ge,a as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-BNjfv0F9.js";import{c as u,U as We}from"./index-C_TX6AZ7.js";import"./vendor-CBmAETR3.js";import"./cross-BJz67Kz5.js";import"./index.es-DlFl3vlr.js";import"./async-directive-CTAY328p.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
========
import{dl as v,dm as f,dn as a}from"./index-CWF6fmRF.js";import{n as w,r as d,o as q}from"./class-map-BMs4QsKg.js";import{w as ve,p as fe,s as ge,a as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-DXlkEQQt.js";import{c as u,U as We}from"./index-Ba7ApQBp.js";import"./vendor-CBmAETR3.js";import"./cross-DqCRmQU4.js";import"./index.es-Cnko9yg2.js";import"./async-directive-CjBatNaP.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
>>>>>>>> 875940e6438f9bb2d7b31566492987440b60d27b:dist/assets/w3m-modal-DXmTOxOc.js
  :host {
    display: block;
