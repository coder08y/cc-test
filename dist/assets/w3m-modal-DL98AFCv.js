<<<<<<<< HEAD:dist/assets/w3m-modal-DeokX8vK.js
import{dl as v,dm as f,dn as a}from"./index-ByUtbMXc.js";import{n as w,r as d,o as q}from"./class-map-Bc8mD0AA.js";import{w as ve,p as fe,s as ge,a as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-DxC93_kW.js";import{c as u,U as We}from"./index-BFIb7hvE.js";import"./vendor-N9FT5NFm.js";import"./cross-MVfrlKDn.js";import"./index.es-CCeEnRFb.js";import"./async-directive-vphN6EAn.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
========
import{dj as v,dk as f,dl as a}from"./index-CzEY8khk.js";import{n as w,r as d,o as q}from"./class-map-D47vqpIj.js";import{w as ve,p as fe,s as ge,a as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-CzKPJAYD.js";import{c as u,U as We}from"./index-DecopMgQ.js";import"./vendor-Bq3XEIti.js";import"./cross-UyvHgEs3.js";import"./index.es-DTIgxKXG.js";import"./async-directive-DcV9BE-4.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
>>>>>>>> fbb2e9029f05f00136e90351b9cd72fadc3ba779:dist/assets/w3m-modal-DL98AFCv.js
  :host {
    display: block;
