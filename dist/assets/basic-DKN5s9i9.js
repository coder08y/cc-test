import{dl as w,eJ as v,bc as $,eU as _,eD as m,ez as u,b8 as ee,dm as l,eA as S,ex as y,fl as $e,fm as vt,eR as k,fn as nt,fo as ve,b4 as Q,eS as pt,eO as R,eP as A,eQ as J,eV as tt,ey as xe,eM as xt,fp as Ct,fq as Wt,eH as _t,ap as ye,fr as Pt,dk as Rt}from"./index--xRmDeIj.js";import{n as c,r as d,o as h}from"./class-map-Bt9PEmyu.js";import{c as f,U as G}from"./index-DG2QOl_D.js";import{b as Lt,e as ot,n as rt}from"./ref-BorKtEON.js";import"./vendor-CBmAETR3.js";import"./cross-BzNM4u9K.js";import"./dijkstra-D_NXgYpA.js";import"./async-directive-DRCTidAJ.js";var be=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let oe=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=v.state.connectors,this.count=$.state.count,this.filteredCount=$.state.filteredWallets.length,this.isFetchingRecommendedWallets=$.state.isFetchingRecommendedWallets,this.unsubscribe.push(v.subscribeKey("connectors",e=>this.connectors=e),$.subscribeKey("count",e=>this.count=e),$.subscribeKey("filteredWallets",e=>this.filteredCount=e.length),$.subscribeKey("isFetchingRecommendedWallets",e=>this.isFetchingRecommendedWallets=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.connectors.find(O=>O.id==="walletConnect"),{allWallets:n}=_.state;if(!e||n==="HIDE"||n==="ONLY_MOBILE"&&!m.isMobile())return null;const o=$.state.featured.length,r=this.count+o,i=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:i;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const p=u.hasAnyConnection(ee.CONNECTOR_ID.WALLET_CONNECT);return l`
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
