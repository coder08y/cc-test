...
`;var M=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let z=class extends m{constructor(){super(...arguments),this.size="md",this.name="",this.installed=!1,this.badgeSize="xs"}render(){let t="1";return this.size==="lg"?t="4":this.size==="md"?t="2":this.size==="sm"&&(t="1"),this.style.cssText=`
   ...
   `,this.dataset.size=this.size,this.imageSrc&&(this.dataset.image="true"),this.walletIcon&&(this.dataset.walletIcon=this.walletIcon),h`
    ...
    `}templateVisual(){return this.imageSrc?h`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:this.walletIcon?h`<wui-icon size="md" color="default" name=${this.walletIcon}></wui-icon>`:h`<wui-icon
      ...
      color="inherit"
      name="wallet"
    ></wui-icon>`}};z.styles=[w,Xe];M([l()],z.prototype,"size",void 0);M([l()],z.prototype,"name",void 0);M([l()],z.prototype,"imageSrc",void 0);M([l()],z.prototype,"walletIcon",void 0);M([l({type:Boolean})],z.prototype,"installed",void 0);M([l()],z.prototype,"badgeSize",void 0);z=M([v("wui-wallet-image")],z);const Ke=L`
  :host {
    position: relative;
    border-radius: ${({borderRadius:e})=>e[2]};
    width: 40px;
...
`;var ne=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};const X=4;let q=class extends m{constructor(){super(...arguments),this.walletImages=[]}render(){const t=this.walletImages.length<X;return h`${this.walletImages.slice(0,X).map(({src:o,walletName:r})=>h`
          ...
          ></wui-wallet-image>
        `)}
    ${t?[...Array(X-this.walletImages.length)].map(()=>h` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};q.styles=[w,Ke];ne([l({type:Array})],q.prototype,"walletImages",void 0);q=ne([v("wui-all-wallets-image")],q);const Je=L`
  :host {
    display: flex;
    justify-content: center;
    align-items: center;
...
`;var Y=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(n<3?a(i):n>3?a(t,o,i):a(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let T=class extends m{constructor(){super(...arguments),this.variant="accent",this.size="md",this.icon=void 0}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;const t=this.size==="md"?"md-medium":"sm-medium",o=this.size==="md"?"md":"sm";return h`
    ...
    `}};T.styles=[w,Je];Y([l()],T.prototype,"variant",void 0);Y([l()],T.prototype,"size",void 0);Y([l()],T.prototype,"icon",void 0);T=Y([v("wui-tag")],T);const Qe=L`
  :host {
    width: 100%;
  }
