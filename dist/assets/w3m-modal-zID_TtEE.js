import{fa as f,fb as v,fc as a}from"./index-CEq787Jy.js";import{n as w,r as d,o as q}from"./class-map-Dj9XbIIo.js";import{w as fe,s as ve,a as ge,p as be,M as g,S as se,R as l,r as P,A as K,e as ce,c as le,C as m,b as Y,d as ye,f as S,E as ie,O as E,g as F,h as oe,i as T,j as H,T as xe,k as Ce,l as ke,m as Se}from"./core-B4vYBsLU.js";import{c as u,U as We}from"./index-CJWGcuzF.js";import"./vendor-Cc2WthaN.js";import"./cross-DG24qctm.js";import"./index.es-3OXYYJ98.js";import"./async-directive-oRhr1Myx.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return ve(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=f`
  :host {
    display: block;
