<<<<<<<< HEAD:dist/assets/basic-CYORZXHb.js
import{dm as w,eP as v,bc as $,e_ as _,eJ as m,eF as u,b8 as ee,dn as l,eG as S,eD as y,fr as $e,fs as vt,eX as k,ft as nt,fu as ve,b4 as Q,eY as pt,eU as R,eV as A,eW as J,e$ as tt,eE as xe,eS as xt,fv as Ct,fw as Wt,eN as _t,ap as ye,fx as Pt,dl as Rt}from"./index-COsYtIaE.js";import{n as c,r as d,o as h}from"./class-map-nFFRZNA3.js";import{c as f,U as G}from"./index-c_co6riX.js";import{b as Lt,e as ot,n as rt}from"./ref-DlEG6q0C.js";import"./vendor-CBmAETR3.js";import"./cross-BJz67Kz5.js";import"./dijkstra-D_NXgYpA.js";import"./async-directive-CTAY328p.js";var be=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let oe=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=v.state.connectors,this.count=$.state.count,this.filteredCount=$.state.filteredWallets.length,this.isFetchingRecommendedWallets=$.state.isFetchingRecommendedWallets,this.unsubscribe.push(v.subscribeKey("connectors",e=>this.connectors=e),$.subscribeKey("count",e=>this.count=e),$.subscribeKey("filteredWallets",e=>this.filteredCount=e.length),$.subscribeKey("isFetchingRecommendedWallets",e=>this.isFetchingRecommendedWallets=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.connectors.find(O=>O.id==="walletConnect"),{allWallets:n}=_.state;if(!e||n==="HIDE"||n==="ONLY_MOBILE"&&!m.isMobile())return null;const o=$.state.featured.length,r=this.count+o,i=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:i;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const p=u.hasAnyConnection(ee.CONNECTOR_ID.WALLET_CONNECT);return l`
========
import{dm as w,eP as v,bc as $,e_ as _,eJ as m,eF as u,b8 as ee,dn as l,eG as S,eD as y,fr as $e,fs as vt,eX as k,ft as nt,fu as ve,b4 as Q,eY as pt,eU as R,eV as A,eW as J,e$ as tt,eE as xe,eS as xt,fv as Ct,fw as Wt,eN as _t,ap as ye,fx as Pt,dl as Rt}from"./index-CWF6fmRF.js";import{n as c,r as d,o as h}from"./class-map-BMs4QsKg.js";import{c as f,U as G}from"./index-WG4P45ct.js";import{b as Lt,e as ot,n as rt}from"./ref-BoGQ9YSA.js";import"./vendor-CBmAETR3.js";import"./cross-DqCRmQU4.js";import"./dijkstra-D_NXgYpA.js";import"./async-directive-CjBatNaP.js";var be=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let oe=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=v.state.connectors,this.count=$.state.count,this.filteredCount=$.state.filteredWallets.length,this.isFetchingRecommendedWallets=$.state.isFetchingRecommendedWallets,this.unsubscribe.push(v.subscribeKey("connectors",e=>this.connectors=e),$.subscribeKey("count",e=>this.count=e),$.subscribeKey("filteredWallets",e=>this.filteredCount=e.length),$.subscribeKey("isFetchingRecommendedWallets",e=>this.isFetchingRecommendedWallets=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.connectors.find(O=>O.id==="walletConnect"),{allWallets:n}=_.state;if(!e||n==="HIDE"||n==="ONLY_MOBILE"&&!m.isMobile())return null;const o=$.state.featured.length,r=this.count+o,i=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:i;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const p=u.hasAnyConnection(ee.CONNECTOR_ID.WALLET_CONNECT);return l`
>>>>>>>> 875940e6438f9bb2d7b31566492987440b60d27b:dist/assets/basic-DLI8kchI.js
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
...
`;var Oe=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let re=class extends w{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=v.state.connectors,this.recommended=$.state.recommended,this.featured=$.state.featured,this.unsubscribe.push(v.subscribeKey("connectors",e=>this.connectors=e),$.subscribeKey("recommended",e=>this.recommended=e),$.subscribeKey("featured",e=>this.featured=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}connectorListTemplate(){const e=$e.getConnectorsByType(this.connectors,this.recommended,this.featured),{custom:n,recent:o,announced:r,injected:i,multiChain:s,recommended:a,featured:p,external:O}=e;return $e.getConnectorTypeOrder({custom:n,recent:o,announced:r,injected:i,multiChain:s,recommended:a,featured:p,external:O}).map(F=>{switch(F){case"injected":return l`
          ...
          ></w3m-connect-external-widget>`;case"recommended":return l`<w3m-connect-recommended-widget
            .wallets=${a}
            tabIdx=${h(this.tabIdx)}
          ></w3m-connect-recommended-widget>`;default:return console.warn(`Unknown connector type: ${F}`),null}})}};re.styles=At;Oe([c()],re.prototype,"tabIdx",void 0);Oe([d()],re.prototype,"connectors",void 0);Oe([d()],re.prototype,"recommended",void 0);Oe([d()],re.prototype,"featured",void 0);re=Oe([f("w3m-connector-list")],re);const Dt=R`
  :host {
    flex: 1;
    height: 100%;
  }
...
`;var Te=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};const zt={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},Nt={lg:"md",md:"sm",sm:"sm"};let se=class extends w{constructor(){super(...arguments),this.icon="mobile",this.size="md",this.label="",this.active=!1}render(){return l`
      <button data-active=${this.active}>
        ${this.icon?l`<wui-icon size=${Nt[this.size]} name=${this.icon}></wui-icon>`:""}
        <wui-text variant=${zt[this.size]}> ${this.label} </wui-text>
      </button>
    `}};se.styles=[A,J,Dt];Te([c()],se.prototype,"icon",void 0);Te([c()],se.prototype,"size",void 0);Te([c()],se.prototype,"label",void 0);Te([c({type:Boolean})],se.prototype,"active",void 0);se=Te([f("wui-tab-item")],se);const Bt=R`
  :host {
    display: inline-flex;
    align-items: center;
...
`;var It=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let De=class extends w{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){const e=this.radius>50?50:this.radius,o=36-e,r=116+o,i=245+o,s=360+o*1.75;return l`
    ...
    `}};De.styles=[A,Vt];It([c({type:Number})],De.prototype,"radius",void 0);De=It([f("wui-loading-thumbnail")],De);const Kt=R`
  wui-flex {
    width: 100%;
    height: 52px;
    box-sizing: border-box;
...
`;var Ye=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let fe=class extends w{constructor(){super(...arguments),this.disabled=!1,this.label="",this.buttonLabel=""}render(){return l`
    ...
    `}};fe.styles=[A,J,Kt];Ye([c({type:Boolean})],fe.prototype,"disabled",void 0);Ye([c()],fe.prototype,"label",void 0);Ye([c()],fe.prototype,"buttonLabel",void 0);fe=Ye([f("wui-cta-button")],fe);const Ft=R`
  :host {
    display: block;
    padding: 0 ${({spacing:t})=>t[5]} ${({spacing:t})=>t[5]};
  }
`;var Et=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let ze=class extends w{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;const{name:e,app_store:n,play_store:o,chrome_store:r,homepage:i}=this.wallet,s=m.isMobile(),a=m.isIos(),p=m.isAndroid(),O=[n,o,i,r].filter(Boolean).length>1,D=G.getTruncateString({string:e,charsStart:12,charsEnd:0,truncate:"end"});return O&&!s?l`
        <wui-cta-button
          label=${`Don't have ${D}?`}
          buttonLabel="Get"
...
`;var K=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let z=class extends w{constructor(){super(...arguments),this.imageSrc="google",this.loading=!1,this.disabled=!1,this.rightIcon=!0,this.rounded=!1,this.fullSize=!1}render(){return this.dataset.rounded=this.rounded?"true":"false",l`
      <button
    ...
    `}templateLeftIcon(){return this.icon?l`<wui-image
      ...
      src=${this.imageSrc}
    ></wui-image>`}templateRightIcon(){return this.rightIcon?this.loading?l`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:l`<wui-icon name="chevronRight" size="lg" color="default"></wui-icon>`:null}};z.styles=[A,J,pi];K([c()],z.prototype,"imageSrc",void 0);K([c()],z.prototype,"icon",void 0);K([c()],z.prototype,"iconColor",void 0);K([c({type:Boolean})],z.prototype,"loading",void 0);K([c()],z.prototype,"tabIdx",void 0);K([c({type:Boolean})],z.prototype,"disabled",void 0);K([c({type:Boolean})],z.prototype,"rightIcon",void 0);K([c({type:Boolean})],z.prototype,"rounded",void 0);K([c({type:Boolean})],z.prototype,"fullSize",void 0);z=K([f("wui-list-item")],z);var fi=function(t,e,n,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(r<3?s(i):r>3?s(e,n,i):s(e,n))||i);return r>3&&i&&Object.defineProperty(e,n,i),i};let $t=class extends w{constructor(){var e;super(...arguments),this.wallet=(e=y.state.data)==null?void 0:e.wallet}render(){if(!this.wallet)throw new Error("w3m-downloads-view");return l`
